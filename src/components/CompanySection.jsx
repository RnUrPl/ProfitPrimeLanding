            ...
            <div className="abcomp_chunk">
                <div className="abcomp_box1">
                    ...
                    <div className="box1_group">
                        ...
                        <span className="box1_subtitle">Пять лет назад мы начали свой путь как<br/> команда трейдеров-разработчиков,<br/> обеспечивая безопасность брокерских <br/>компаний. Мы разрабатывали программные<br/> решения для защиты от арбитражных <br/>команд, сохраняя миллионы долларов таким <br/>крупным брокерам, как roboforex и quotex. <br/><br/>За годы взаимодействия с крупнейшими<br/> игроками рынка мы узнали не только все <br/>тонкости их работы, но и неприятную <br/>правду о том, как они обходились со <br/>своими клиентами.</span>
                    </div>
                </div>
                <div className="abcomp_box1">
                    <span className='box1_num'>5</span>
