...
const TradersSection = () => {
  ...
  const [selectedTrader, setSelectedTrader] = useState(null);
    ...
    var tradersData = [
      { name: 'Мохсен Азади', sub: 'Forex + Аcademy', starsAlt: '5 stars' , text: 'На старте покупал только систему для торговли на Forex. С инструкцией разобрался, попробовал сам выставить настройки для работы. Получалось делать 20% в день, но хотелось больше. Решил уточнить у ребят, как можно повысить профит. Вступил в академию, сразу изучил гайд по подбору брокеров и настройке торговых пар. Повезло, в чате даже нашел парня, который занимается аккаунтами. Конечно, мне есть куда расти, но и сейчас всё неплохо. Сделки с одного из аккаунтов на видео. Всем удачи!',video:RM},
