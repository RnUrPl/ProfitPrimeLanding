    ...
    <section id="company" className='company'>
        ...
        <div className="abcomp_group">
            ...
            <div className="box1_group">
                ...
                <span className="box3_subtitle">Более 3-х лет мы разрабатываем продвинутые торговые системы, которые помогают начинающим трейдерам не только вернуть потерянные средства, но и начать по-настоящему зарабатывать на трейдинге.<br/><br/>

Наша компания ведёт активную разработку в области интеграции искусственного интеллекта в торговые системы для полной автоматизации анализа и открытия сделок. На данный момент мы выпустили на рынок 4 абсолютно уникальных продукта, которые обходят все существующие ограничения со стороны брокера.</span>
            </div>
            </div>
...
Мы не только проводим консультации с клиентами, чтобы подобрать наиболее подходящий продукт для комфортной торговли, но и сопровождаем их на всем пути совместной работы. Это наш главный принцип, благодаря которому нас выбирают тысячи экспертов и новичков в трейдинге на протяжении уже 3 лет.</span>
            </div>
            </div>
        </div>
    </div>
