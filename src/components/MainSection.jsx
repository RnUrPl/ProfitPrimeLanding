    ...
    switch (qwertContent) {
      ...
      case '2':
        ...
        case '3':
          ...
          : <div className='qwert_subtitile'>Продвинутое решение, объединяющее в себе различные стратегии для полностью автоматизированной торговли не только на Forex брокерах, но и на крипто биржах. <br/><br/>Революционные алгоритмы ипользуют задержки в передаче данных между брокером и поставщиком котировок, проводят арбитраж между несколькими счетами, а также анализируют исторические корреляции без вашего участия.</div>}
                        </div>
            ...
            case '4':
              return (
                <div className="qwertInfo">
                            ...
                            <div className="qwert_subtitile">
                        {isMobile
          ? 'Наша автоматизированная система быстро и точно анализирует котировки, предвидя изменения курса актива на 1-2 секунды раньше брокера. Это позволяет трейдерам одновременно открывать выгодные сделки для максимальной прибыли и уверенности в своих решениях.'
          : <div className='qwert_subtitile'>Автоматизированная торговая система, алгоритм  которой анализирует поставщиков котировок на сторонах брокера и трейдера, определяя выгодный для трейдера разрыв между ними перед открытием сделки. <br/><br/>Система всегда знает курс актива на 1-2 секунды раньше, чем брокер, что позволяет ей вовремя открывать сделки, получая максимальную прибыль.</div>}
                        </div>
                </div>
